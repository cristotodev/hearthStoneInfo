...
public class PanelDerechoModel {
	//TODO el id puede sobrar
	...
	//TODO cambiar object por file o image para las imagenes de las cartas
	private ObjectProperty<Object> img;
	private ObjectProperty<Object> imgDorada;
	private StringProperty mecanismo;

	public PanelDerechoModel() {
	...
	public final ObjectProperty<Object> imgProperty() {
		return this.img;
	}
	...
	public final void setImg(final Object img) {
		this.imgProperty().set(img);
	}
	

	public final ObjectProperty<Object> imgDoradaProperty() {
		return this.imgDorada;
	}
	

	public final Object getImgDorada() {
		return this.imgDoradaProperty().get();
	}
	

	public final void setImgDorada(final Object imgDorada) {
